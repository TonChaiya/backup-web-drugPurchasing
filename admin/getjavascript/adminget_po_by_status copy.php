    ...
    try {
        ...
        if ($records) {
            ...
            foreach ($records as $record) {
                ...
                echo '<a href="../admin/generate_pdfforgporequest.php?po_number=' . urlencode($record['po_number']) . '" target="_blank" class="text-blue-500 hover:underline ml-2">View</a>'; // ปุ่มดูใบเบิกในรูปแบบ PDF
                echo ' | ';
                echo '<a href="../admin/download_pdf.php?po_number=' . urlencode($record['po_number']) . '" class="text-green-500 hover:underline ml-2">Download</a>'; // ปุ่มดาวน์โหลด PDF
                echo '</td>';
